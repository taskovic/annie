...
import { makeStyles, Modal as ModalBase, Backdrop, Fade, Button, IconButton } from '@mui/material';
            ...
            >
                <Fade in={open}>
                    <div className="annie-modal-content">
                        {children}
                        <IconButton className="annie-modal-close-button" onClick={handleClose}>
